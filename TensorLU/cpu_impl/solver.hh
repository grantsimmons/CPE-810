...
public:
    ...
    void solve() {
        ...
        std::cout << "cpu time (ns): " << duration.count() << std::endl;
	    std::cout << "GFlop/s: " << (double) (2.0 * matrix_.elem_cols_ * matrix_.elem_rows_ * matrix_.elem_rows_ / (3.0 * (double)(duration.count()))) << std::endl;
    }
};
